    ...
    private
      ...
      def set_advantage_navs
        @advantage_navs = [
          ...
          {path: advantages_innovation_construction_path, matcher: '/advantages/innovation', img_path: 'media/images/advantages/navs/2.png', active_img_path: 'media/images/advantages/navs/02.png'},
